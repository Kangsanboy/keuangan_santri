...
const AttendanceMonitoring = () => {
  ...
  const [schedules, setSchedules] = useState<Schedule[]>([]); // 🔥 Data Jadwal
  ...
  const renderKbmFlow = () => {
      ...
      if (!selectedKbmSubject) {
          // 🔥 Hanya munculkan mapel yang dijadwalkan untuk kelas ini
  ...
  const renderMengajiFlow = () => {
      ...
      if (!selectedMengajiSubject) {
          // 🔥 Hanya munculkan waktu mengaji yang dijadwalkan
  ...
  const renderSholatFlow = () => {
      ...
      if (!selectedSholatSubject) {
          // 🔥 Hanya munculkan sholat yang ada di master jadwal
  ...
  const renderEkskulFlow = () => {
      if (!selectedEkskul) {
          // 🔥 Hanya munculkan ekskul yang dijadwalkan
  ...
  const renderGuruKbmFlow = () => {
        if (!selectedGuruKbmSubject) {
            // 🔥 Hanya mapel yang punya jadwal guru pengampu

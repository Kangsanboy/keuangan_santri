...
import { User, Shield, Users, Edit, Search, Rocket } from "lucide-react"; // 🔥 Icon Rocket Buat Super Admin
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-purple-50 border-purple-200 shadow-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <p className="text-xs text-purple-600 mt-1">Akses Penuh</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-green-50 border-green-200 shadow-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <p className="text-xs text-green-600 mt-1">Pengelola</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-blue-50 border-blue-200 shadow-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <p className="text-xs text-blue-600 mt-1">Hanya Lihat</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-yellow-50 border-yellow-200 shadow-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <p className="text-xs text-yellow-600 mt-1">Butuh Verifikasi</p>
          </CardContent>
        </Card>
      </div>
